...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav ml-auto">
                        <a class="nav-link active" aria-current="page" href="#" style="color: #06444a">Home</a>
                        <a class="nav-link" href="/Menu" style="color: #18978F">Menu</a>
                        <a class="nav-link" href="/Promote" style="color: #18978F">Promotion</a>
                        <a class="nav-link" href="#footer" style="color: #18978F">Contact Us</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../Assets/wlcm.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="../Assets/wlcm2.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="../Assets/wlcm3.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
    ...
    <div id="B">
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../Assets/qq.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="../Assets/ss.jpg" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="../Assets/rr.jpg" class="d-block w-100" alt="...">
                </div>
            </div>
    ...
    {{-- Card --}}
    <section class="py-5">
        <h3 style="text-align: center; font-family: Viga, sans-serif; color: #06444a">Rekomendation</h3>
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
                        <img class="card-img-top" src="../Assets/soto/stb.jpg" alt="..." />
                        <!-- Product details-->
    ...
    <footer id="footer">
        ...
        <button class="btn btn-outline-white" style="float: right; margin-top: -50px; margin-right: 15px; background: #06444a">
